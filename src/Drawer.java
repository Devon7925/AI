...
class Drawer {
    ...
    void drawLine(double x, double y, double x1, double y1, Color c){
        g2.setStroke(new BasicStroke(5));
    ...
    void drawLine(double x, double y, double x1, double y1, Color c, int a){
